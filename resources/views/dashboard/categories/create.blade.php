...
@section('container')
    ...
    <div class="py-4 px-4 mx-auto">
        ...
        <form action="/dashboard/categories" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="inline-flex px-5 py-2.5 mt-6 sm:mt-6 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                Add category
            </button>
        </form>
    </div>
