        ...
        <form action="/dashboard/courses/{{ $course->slug }}" method="post">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input id="description" class="@error('description') border-red-500 @else border-gray-300 @enderror" type="hidden" name="description" value="{{ old('description' , $course->description) }}">
                    @error('description')
